...
@stt_router.get("/start", summary="STT 인식 시작", description="Azure STT 인식을 시작합니다.")
def start_stt():
...
@stt_router.get("/stop", summary="STT 인식 종료", description="Azure STT 인식을 종료합니다.")
def stop_stt():
    # STT 인식을 종료합니다.
